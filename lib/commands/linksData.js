...
function add(link) {
  ...
  console.log(clc.yellow("(Make sure the link looks as you planned. Varify trailing slashes validity)."));
  return true;
}
...
function getNextToSync(links) {
  ...
  console.log(clc.green('Seems like everything was synced in the last 24 hours! :]'))
  process.exit();
}
